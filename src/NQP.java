...
public class NQP {
    ...
    public static void main(String[] args) {
        ...
        placeQueens(40); // Lets take example of 4*4
    }
    ...
    private static boolean placeAllQueens(@NotNull int[][] board, int row){
        if(row>=board.length){
            return true;
        }
    ...
    private static void printBoard(@NotNull int[][] board){
        long startTime = System.currentTimeMillis();
        for (int[] ints : board) {
